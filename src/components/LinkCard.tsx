...
const ICONS: Record<string, JSX.Element> = {
  website: (
    <svg className="w-5 h-5 text-blue-400 group-hover:text-blue-500" fill="currentColor" viewBox="0 0 20 20">
      <path
        fillRule="evenodd"
...
const LinkCard: React.FC<Link & { icon?: string }> = ({ href, title, icon = "default", image }) => {
  const getIcon = () => {
